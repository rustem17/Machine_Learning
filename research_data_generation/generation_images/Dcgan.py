...
def load_xrays(epochs=100, batch_size=32):
    (img_x, img_y) = 128, 128
    train_path = "~/Downloads/rustems/imagen/newDataTrain.csv"
    ...
    image_path = "~/Downloads/rustems/imagen/images11"
...
if __name__ == '__main__':
    ...
    for label in OHE_labels:
        for num in range(1000):
            ...
            # cnt+=1
            fig.savefig("~/Downloads/rustems/imagen/images/class1" + str(label) + "-" + str(num) + ".png")
            plt.clf()
